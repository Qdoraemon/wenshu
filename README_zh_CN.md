...
文枢笔记是一款隐私优先的个人知识管理系统，支持细粒度块级引用和 Markdown 所见即所得。
...
欢迎到[文枢笔记官方讨论区](https://ld246.com/domain/siyuan)了解更多。同时也欢迎关注 B3log 开源社区微信公众号 `B3log开源`：
...
![文枢笔记架构设计](https://b3logfile.com/file/2023/05/SiYuan_Arch-Sgu8vXT.png "文枢笔记架构设计")
...
- [文枢笔记开发计划和进度](https://github.com/orgs/siyuan-note/projects/1)
- [文枢笔记版本变更和公告](CHANGELOG.md)
...
对于使用 Docker Compose 运行文枢的用户，可以通过环境变量 `PUID` 和 `PGID` 来自定义用户和组的 ID。下面是一个 Docker Compose 配置示例：
...
3. 安装完成后在 `Docker-应用商店-实用工具` 中找到 `文枢笔记`，点击`安装`，也可以在搜索框直接搜索
4. 设置域名等基本信息，点击 `确定`
...
- 如果是桌面端通过安装包安装的，可打开 <kbd>设置</kbd> - <kbd>关于</kbd> - <kbd>自动下载更新安装包</kbd> 选项，这样文枢会自动下载最新版安装包并提示安装
...
文枢的诞生离不开众多的开源项目和贡献者，请参考项目源代码 kernel/go.mod、app/package.json 和项目首页。

文枢的成长离不开用户的反馈和宣传推广，感谢所有人对文枢的帮助 ❤️
