...
- [Pad 端支持文枢协议 `siyuan://` 跳转打开](https://github.com/siyuan-note/siyuan/issues/7713)
...
- [支持去掉 PDF 导出页脚处 `由文枢笔记导出`](https://github.com/siyuan-note/siyuan/issues/6881)
...
- [PDF 导出页脚处添加 `由文枢笔记导出`](https://github.com/siyuan-note/siyuan/issues/6849)
...
- [听说文枢笔记会通过用户电脑挖矿](https://github.com/siyuan-note/siyuan/issues/6416)
...
- [严格校验文枢块超链接地址](https://github.com/siyuan-note/siyuan/issues/5284)
...
- [为文枢协议链接添加 Alt/Shift/Ctrl+Click 事件](https://github.com/siyuan-note/siyuan/issues/4602)
...
- [文枢超链接支持浮窗预览](https://github.com/siyuan-note/siyuan/issues/3302)
...
- [文枢协议块超链接加入 `focus` 参数](https://github.com/siyuan-note/siyuan/issues/4221)
...
- [不关闭文枢几天后可能出现账号鉴权失败](https://github.com/siyuan-note/siyuan/issues/4080)
...
- [IPAD 文枢无法卸载主题，卸载 APP 后重装仍然有](https://github.com/siyuan-note/siyuan/issues/3619)
...
- [窗口最小化时，文枢协议无法唤起窗口](https://github.com/siyuan-note/siyuan/issues/3447)
...
- [能否加入\ket \bra 等更全的 tex 符号支持](https://github.com/siyuan-note/siyuan/issues/3352)
...
- [自定义快捷键 bug——表格功能中左右方向键无法识别](https://github.com/siyuan-note/siyuan/issues/3353)
...
- [13 后回车改进：由生成 1 同级列表修改为生成 13 下方的空块](https://github.com/siyuan-note/siyuan/issues/3118)
...
- [剪藏扩展点击发送到文枢后关闭面板](https://github.com/siyuan-note/siyuan/issues/2993)
...
- [(( 新建文档 32 个字符限制改为 512 个](https://github.com/siyuan-note/siyuan/issues/2853)
- [使用非中文和英文外观时统一使用英文帮助文档](https://github.com/siyuan-note/siyuan/issues/2859)

### 修复缺陷

- [列表项内用 ctrl+↑ 折叠，块标变成段落块](https://github.com/siyuan-note/siyuan/issues/2809)
...
- [同一个块内有 2 个引用时产生的问题](https://github.com/siyuan-note/siyuan/issues/2825)
...
- [启动文枢后，点击页签，光标不会聚焦到编辑器上](https://github.com/siyuan-note/siyuan/issues/2678)
...
- [剪切单个块粘贴后 id 会变，且再次粘贴错误](https://github.com/siyuan-note/siyuan/issues/2661)
...
- [重启文枢导致列表背景色丢失](https://github.com/siyuan-note/siyuan/issues/2629)
...
- [增加行宽度 75](https://github.com/siyuan-note/siyuan/issues/2294)
...
- [去掉文件夹下对非文枢 .md 的导入支持](https://github.com/siyuan-note/siyuan/issues/1104)
...
- [在引用块的中间部分按下 Enter 两次会直接跳出引用块](https://github.com/siyuan-note/siyuan/issues/1081)
...
- [文枢在线工作空间会话鉴权](https://github.com/siyuan-note/siyuan/issues/381)
...
- [文枢在线（Xanadu）移动端添加 PWA](https://github.com/siyuan-note/siyuan/issues/265)
